...
const MovieInformation = () => {
  ...
  const {data:favoritesMovies} = useGetListQuery({listName:"favorite/movies", accountId: user.id, sessionId:localStorage.getItem("session_id"), page:1});
 ...
 setIsMovieWatchListed(prevState => !prevState )
  ...
  if(error){
    return(
      ...
      <Link to="/">Something has gone wrong - Go back a step</Link>
      </Box>
    )
  }
